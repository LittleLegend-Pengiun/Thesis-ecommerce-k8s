...
\includepdf[pages=-]{pdf/hard_cover.pdf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%% Phiếu nhiệm vụ %%%%%%%%%%%%%%%%%%%%%
\includepdf[pages=-]{pdf/Phieu_NVLV.pdf}

\newpage
\thispagestyle{empty}

%%%%%%%%%%%%%%%%%%%%%%% Phiếu chấm hướng dẫn %%%%%%%%%%%%%%%%%%
\includepdf[pages=-]{pdf/Phieu_GVHD.pdf}

\newpage
\thispagestyle{empty}
%%%%%%%%%%%%%%%%%%%%%%%%%% Phiếu phản biện %%%%%%%%%%%%%%%%%%%%
\includepdf[pages=-]{pdf/Phieu_cham_PB.pdf}

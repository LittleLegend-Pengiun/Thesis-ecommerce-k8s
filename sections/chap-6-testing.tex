...
\subsubsection{Kiểm tra tính sẵn sàng của hệ thống khi có tải cao}
\noindent Để mô phỏng tình huống, ta sử dụng k6 để giả lập tình huồng khi hệ thống nhận lượng request tăng cao. Với 1 pod bình thường của microservice \lstinline|catalog-ms|, ta thu được kết quả như hình \ref{fig:catalog-stress-test-no-hpa}.
\begin{figure}[H]
  \begin{center}
...
Khi sử dụng service LoadBalancer kèm với Horizontal Pod Autoscaler, ta có được một giải pháp giúp hệ thống có thể tự động mở rộng, tăng khả năng đáp ứng dịch vụ, từ đó tăng tính sẵn sàng.
...
\subsection{Kiểm thử tính sẵn sàng - availability}

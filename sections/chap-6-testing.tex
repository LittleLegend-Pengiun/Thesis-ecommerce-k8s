...
\subsubsection{Trường hợp hệ thống chịu tải cao}
\noindent Với việc sử dụng kết hợp khả năng phân phối tải của Load Balancer và khả năng duy trì số lượng pod của ReplicaSets/Deployment, 

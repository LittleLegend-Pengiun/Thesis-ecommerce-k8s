\begin{titlepage}
    ...
    \begingroup
        ...
        \begin{center}
            \textbf{PHÁT TRIỂN HỆ THỐNG THƯƠNG MẠI ĐIỆN TỬ CÓ TÍNH SẴN SÀNG VÀ TÍNH MỞ RỘNG CAO CHO SẢN PHẨM CÔNG NGHỆ}
        \end{center}       
    \endgroup
    ...
    \begingroup
        ...
        \begin{center}
            \begin{tabular}{rll}
                \color{black} \textbf{Hội đồng:} & \color{black} KHOA HỌC MÁY TÍNH 13 &  \\
